...
public class OperatorsController : ControllerBase
{
    ...
    /// <summary>
    /// Retreats from the active combat session, clearing the operator's <c>ActiveCombatSessionId</c>
    /// reference without deleting the session record, preserving the full audit trail.
    /// The operator remains in Infil mode.
    /// </summary>
    /// <param name="id">The operator's unique identifier.</param>
