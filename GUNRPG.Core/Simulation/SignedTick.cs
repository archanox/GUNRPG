...
/// <param name="StateHash">SHA-256 hash of the simulation state after this tick.</param>
/// <param name="InputHash">SHA-256 hash of the player input that drove this tick.</param>
/// <param name="Signature">Ed25519 signature over the canonical payload (Tick ‖ StateHash ‖ InputHash).</param>
